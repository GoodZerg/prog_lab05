 ...
 */
public class CommandUpdate extends Command implements RemoteCommand {
     ...
     */
    public CommandUpdate(DeqCollection<Route> data, Long id, BufferedReader reader, boolean isStandardInput) {
        super(data);
        this.id = id;
        this.reader = reader;
